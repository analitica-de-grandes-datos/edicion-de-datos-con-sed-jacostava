...
#
sed 's/[a-z]/\U&/g; s/\([0-9]\)\/\([0-9]\)\//0\1\/0\2\//g; s/\/20/\//g; s/\([0-9][0-9]\)\/\([0-9][0-9]\)\/\([0-9][0-9]\)/20\3-\2-\1/g; s/,/./g; s/;/,/g; s/,,/,\\N,/g; s/,N,/,null,/g; s/,N/,null/g; s/null/\\N/g; s/,,/,\\N,/g; s/,\s*$/,\\N/g; s/a/A/g; s/c/C/g;' data.csv > output.csv